...
static_assert(sizeof(ANavigationData) == 0x0004E8, "Wrong size on ANavigationData");
static_assert(offsetof(ANavigationData, RenderingComp) == 0x000330, "Member 'ANavigationData::RenderingComp' has a wrong offset!");
static_assert(offsetof(ANavigationData, NavDataConfig) == 0x000338, "Member 'ANavigationData::NavDataConfig' has a wrong offset!");
static_assert(offsetof(ANavigationData, RuntimeGeneration) == 0x0003A4, "Member 'ANavigationData::RuntimeGeneration' has a wrong offset!");
static_assert(offsetof(ANavigationData, ObservedPathsTickInterval) == 0x0003A8, "Member 'ANavigationData::ObservedPathsTickInterval' has a wrong offset!");
static_assert(offsetof(ANavigationData, DataVersion) == 0x0003AC, "Member 'ANavigationData::DataVersion' has a wrong offset!");
static_assert(offsetof(ANavigationData, SupportedAreas) == 0x000480, "Member 'ANavigationData::SupportedAreas' has a wrong offset!");
...
static_assert(sizeof(AAbstractNavData) == 0x0004E8, "Wrong size on AAbstractNavData");
...
static_assert(sizeof(ARecastNavMesh) == 0x000590, "Wrong size on ARecastNavMesh");
static_assert(offsetof(ARecastNavMesh, DrawOffset) == 0x0004EC, "Member 'ARecastNavMesh::DrawOffset' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TilePoolSize) == 0x0004F4, "Member 'ARecastNavMesh::TilePoolSize' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TileSizeUU) == 0x0004F8, "Member 'ARecastNavMesh::TileSizeUU' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, CellSize) == 0x0004FC, "Member 'ARecastNavMesh::CellSize' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, CellHeight) == 0x000500, "Member 'ARecastNavMesh::CellHeight' has a wrong offset!");
...
static_assert(offsetof(ARecastNavMesh, AgentMaxHeight) == 0x00050C, "Member 'ARecastNavMesh::AgentMaxHeight' has a wrong offset!");
...
static_assert(offsetof(ARecastNavMesh, HeuristicScale) == 0x000558, "Member 'ARecastNavMesh::HeuristicScale' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, VerticalDeviationFromGroundCompensation) == 0x00055C, "Member 'ARecastNavMesh::VerticalDeviationFromGroundCompensation' has a wrong offset!");
...
static_assert(sizeof(ANavigationGraph) == 0x0004E8, "Wrong size on ANavigationGraph");
...
static_assert(sizeof(ANavigationGraphNode) == 0x000328, "Wrong size on ANavigationGraphNode");
...
static_assert(offsetof(UNavigationGraphNodeComponent, Node) == 0x000238, "Member 'UNavigationGraphNodeComponent::Node' has a wrong offset!");
static_assert(offsetof(UNavigationGraphNodeComponent, NextNodeComponent) == 0x000250, "Member 'UNavigationGraphNodeComponent::NextNodeComponent' has a wrong offset!");
static_assert(offsetof(UNavigationGraphNodeComponent, PrevNodeComponent) == 0x000258, "Member 'UNavigationGraphNodeComponent::PrevNodeComponent' has a wrong offset!");
...
static_assert(sizeof(ANavigationTestingActor) == 0x000410, "Wrong size on ANavigationTestingActor");
static_assert(offsetof(ANavigationTestingActor, CapsuleComponent) == 0x000338, "Member 'ANavigationTestingActor::CapsuleComponent' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, InvokerComponent) == 0x000340, "Member 'ANavigationTestingActor::InvokerComponent' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, NavAgentProps) == 0x000350, "Member 'ANavigationTestingActor::NavAgentProps' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, QueryingExtent) == 0x000380, "Member 'ANavigationTestingActor::QueryingExtent' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, MyNavData) == 0x000390, "Member 'ANavigationTestingActor::MyNavData' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, ProjectedLocation) == 0x000398, "Member 'ANavigationTestingActor::ProjectedLocation' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, CostDisplayMode) == 0x0003A8, "Member 'ANavigationTestingActor::CostDisplayMode' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, TextCanvasOffset) == 0x0003AC, "Member 'ANavigationTestingActor::TextCanvasOffset' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathfindingTime) == 0x0003B8, "Member 'ANavigationTestingActor::PathfindingTime' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathCost) == 0x0003BC, "Member 'ANavigationTestingActor::PathCost' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathfindingSteps) == 0x0003C0, "Member 'ANavigationTestingActor::PathfindingSteps' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, OtherActor) == 0x0003C8, "Member 'ANavigationTestingActor::OtherActor' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, FilterClass) == 0x0003D0, "Member 'ANavigationTestingActor::FilterClass' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, ShowStepIndex) == 0x0003D8, "Member 'ANavigationTestingActor::ShowStepIndex' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, OffsetFromCornersDistance) == 0x0003DC, "Member 'ANavigationTestingActor::OffsetFromCornersDistance' has a wrong offset!");
...
static_assert(offsetof(UNavLinkComponent, Links) == 0x000568, "Member 'UNavLinkComponent::Links' has a wrong offset!");
...
static_assert(sizeof(UNavLinkCustomComponent) == 0x0001C8, "Wrong size on UNavLinkCustomComponent");
...
static_assert(offsetof(UNavLinkCustomComponent, LinkRelativeEnd) == 0x00014C, "Member 'UNavLinkCustomComponent::LinkRelativeEnd' has a wrong offset!");
...
static_assert(offsetof(UNavLinkCustomComponent, ObstacleExtent) == 0x00016C, "Member 'UNavLinkCustomComponent::ObstacleExtent' has a wrong offset!");
static_assert(offsetof(UNavLinkCustomComponent, ObstacleAreaClass) == 0x000178, "Member 'UNavLinkCustomComponent::ObstacleAreaClass' has a wrong offset!");
static_assert(offsetof(UNavLinkCustomComponent, BroadcastRadius) == 0x000180, "Member 'UNavLinkCustomComponent::BroadcastRadius' has a wrong offset!");
static_assert(offsetof(UNavLinkCustomComponent, BroadcastInterval) == 0x000184, "Member 'UNavLinkCustomComponent::BroadcastInterval' has a wrong offset!");
static_assert(offsetof(UNavLinkCustomComponent, BroadcastChannel) == 0x000188, "Member 'UNavLinkCustomComponent::BroadcastChannel' has a wrong offset!");
...
static_assert(sizeof(ANavMeshBoundsVolume) == 0x000368, "Wrong size on ANavMeshBoundsVolume");
static_assert(offsetof(ANavMeshBoundsVolume, SupportedAgents) == 0x000360, "Member 'ANavMeshBoundsVolume::SupportedAgents' has a wrong offset!");
...
static_assert(sizeof(UNavModifierComponent) == 0x000148, "Wrong size on UNavModifierComponent");
...
static_assert(sizeof(ANavModifierVolume) == 0x000370, "Wrong size on ANavModifierVolume");
static_assert(offsetof(ANavModifierVolume, AreaClass) == 0x000368, "Member 'ANavModifierVolume::AreaClass' has a wrong offset!");
