...
{
public:
	class UWidgetTree*                            WidgetTree;                                        // 0x0358(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowTemplate;                                    // 0x0360(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_361[0x7];                                      // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FDelegateRuntimeBinding>        Bindings;                                          // 0x0368(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UWidgetAnimation*>               Animations;                                        // 0x0378(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<class FName>                           NamedSlots;                                        // 0x0388(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bValidTemplate;                                    // 0x0398(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bTemplateInitialized;                              // 0x0399(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCookedTemplate;                                   // 0x039A(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_39B[0x5];                                      // 0x039B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UUserWidget>             TemplateAsset;                                     // 0x03A0(0x0020)(ExportObject, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UUserWidget*                            Template;                                          // 0x03C0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UWidgetBlueprintGeneratedClass) == 0x0003C8, "Wrong size on UWidgetBlueprintGeneratedClass");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, WidgetTree) == 0x000358, "Member 'UWidgetBlueprintGeneratedClass::WidgetTree' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, bAllowTemplate) == 0x000360, "Member 'UWidgetBlueprintGeneratedClass::bAllowTemplate' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Bindings) == 0x000368, "Member 'UWidgetBlueprintGeneratedClass::Bindings' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Animations) == 0x000378, "Member 'UWidgetBlueprintGeneratedClass::Animations' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, NamedSlots) == 0x000388, "Member 'UWidgetBlueprintGeneratedClass::NamedSlots' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, bValidTemplate) == 0x000398, "Member 'UWidgetBlueprintGeneratedClass::bValidTemplate' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, bTemplateInitialized) == 0x000399, "Member 'UWidgetBlueprintGeneratedClass::bTemplateInitialized' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, bCookedTemplate) == 0x00039A, "Member 'UWidgetBlueprintGeneratedClass::bCookedTemplate' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, TemplateAsset) == 0x0003A0, "Member 'UWidgetBlueprintGeneratedClass::TemplateAsset' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Template) == 0x0003C0, "Member 'UWidgetBlueprintGeneratedClass::Template' has a wrong offset!");
