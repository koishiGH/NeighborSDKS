...
{
public:
	struct FMediaPlaneParameters                  Plane;                                             // 0x0660(0x0040)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMediaPlaneComponent) == 0x000730, "Wrong size on UMediaPlaneComponent");
static_assert(offsetof(UMediaPlaneComponent, Plane) == 0x000660, "Member 'UMediaPlaneComponent::Plane' has a wrong offset!");
...
static_assert(sizeof(UMediaPlaneFrustumComponent) == 0x000660, "Wrong size on UMediaPlaneFrustumComponent");
...
public:
	...
	class UMediaSoundComponent*                   MediaSoundComponent;                               // 0x0120(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMediaTexture*                          MediaTexture;                                      // 0x0128(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneMediaSection, MediaSoundComponent) == 0x000120, "Member 'UMovieSceneMediaSection::MediaSoundComponent' has a wrong offset!");
...
{
public:
	TArray<class UMovieSceneSection*>             MediaSections;                                     // 0x00B8(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneMediaTrack, MediaSections) == 0x0000B8, "Member 'UMovieSceneMediaTrack::MediaSections' has a wrong offset!");
