...
{
public:
	struct FGuid                                  Signature;                                         // 0x0000(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FFloatRange>                    Ranges;                                            // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMovieSceneEvaluationField) == 0x000040, "Wrong size on FMovieSceneEvaluationField");
static_assert(offsetof(FMovieSceneEvaluationField, Signature) == 0x000000, "Member 'FMovieSceneEvaluationField::Signature' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationField, Ranges) == 0x000010, "Member 'FMovieSceneEvaluationField::Ranges' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationField, Groups) == 0x000020, "Member 'FMovieSceneEvaluationField::Groups' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationField, MetaData) == 0x000030, "Member 'FMovieSceneEvaluationField::MetaData' has a wrong offset!");
...
public:
	...
	struct FMovieSceneEvaluationField             EvaluationField;                                   // 0x00A0(0x0040)(NativeAccessSpecifierPublic)
	struct FMovieSceneSequenceHierarchy           Hierarchy;                                         // 0x00E0(0x00A0)(NativeAccessSpecifierPublic)
	struct FGuid                                  SequenceSignature;                                 // 0x0180(0x0010)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneTemplateGenerationLedger    TemplateLedger;                                    // 0x0190(0x00A8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneTrackFieldData              TrackFieldData;                                    // 0x0238(0x0060)(NativeAccessSpecifierPrivate)
	struct FMovieSceneSubSectionFieldData         SubSectionFieldData;                               // 0x0298(0x0060)(NativeAccessSpecifierPrivate)
};
static_assert(alignof(FMovieSceneEvaluationTemplate) == 0x000008, "Wrong alignment on FMovieSceneEvaluationTemplate");
static_assert(sizeof(FMovieSceneEvaluationTemplate) == 0x0002F8, "Wrong size on FMovieSceneEvaluationTemplate");
...
static_assert(offsetof(FMovieSceneEvaluationTemplate, Hierarchy) == 0x0000E0, "Member 'FMovieSceneEvaluationTemplate::Hierarchy' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationTemplate, SequenceSignature) == 0x000180, "Member 'FMovieSceneEvaluationTemplate::SequenceSignature' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationTemplate, TemplateLedger) == 0x000190, "Member 'FMovieSceneEvaluationTemplate::TemplateLedger' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationTemplate, TrackFieldData) == 0x000238, "Member 'FMovieSceneEvaluationTemplate::TrackFieldData' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationTemplate, SubSectionFieldData) == 0x000298, "Member 'FMovieSceneEvaluationTemplate::SubSectionFieldData' has a wrong offset!");
