...
{
public:
	uint8                                         Pad_530[0x1A0];                                    // 0x0530(0x01A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x0006D0, "Wrong size on FAnimSequencerInstanceProxy");
