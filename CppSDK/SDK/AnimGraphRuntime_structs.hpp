...
{
public:
	uint8                                         Pad_3C0[0x1B0];                                    // 0x03C0(0x01B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000570, "Wrong size on FAnimSequencerInstanceProxy");
