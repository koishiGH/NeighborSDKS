...
// 0x0050 (0x0050 - 0x0000)
struct alignas(0x50) GeometryCacheTrack_TransformGroupAnimation_SetMesh final
{
public:
	struct FGeometryCacheMeshData                 NewMeshData;                                       // 0x0000(0x0050)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(GeometryCacheTrack_TransformGroupAnimation_SetMesh) == 0x000050, "Wrong alignment on GeometryCacheTrack_TransformGroupAnimation_SetMesh");
