...
static_assert(sizeof(UAkAssetDataSwitchContainer) == 0x0000E0, "Wrong size on UAkAssetDataSwitchContainer");
...
public:
	...
	TSet<class UAkAudioEvent*>                    PostedEvents;                                      // 0x0140(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TSet<class UAkAuxBus*>                        UserDefinedSends;                                  // 0x0190(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TSet<class UAkTrigger*>                       PostedTriggers;                                    // 0x01E0(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TSet<class UAkGroupValue*>                    GroupValues;                                       // 0x0230(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkAudioEventData) == 0x0002A8, "Wrong size on UAkAudioEventData");
static_assert(offsetof(UAkAudioEventData, MaxAttenuationRadius) == 0x0000E0, "Member 'UAkAudioEventData::MaxAttenuationRadius' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, IsInfinite) == 0x0000E4, "Member 'UAkAudioEventData::IsInfinite' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, MinimumDuration) == 0x0000E8, "Member 'UAkAudioEventData::MinimumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, MaximumDuration) == 0x0000EC, "Member 'UAkAudioEventData::MaximumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, LocalizedMedia) == 0x0000F0, "Member 'UAkAudioEventData::LocalizedMedia' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, PostedEvents) == 0x000140, "Member 'UAkAudioEventData::PostedEvents' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, UserDefinedSends) == 0x000190, "Member 'UAkAudioEventData::UserDefinedSends' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, PostedTriggers) == 0x0001E0, "Member 'UAkAudioEventData::PostedTriggers' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, GroupValues) == 0x000230, "Member 'UAkAudioEventData::GroupValues' has a wrong offset!");
...
static_assert(sizeof(UAkMediaAssetData) == 0x000060, "Wrong size on UAkMediaAssetData");
...
static_assert(sizeof(UAkSubmixInputComponent) == 0x000470, "Wrong size on UAkSubmixInputComponent");
static_assert(offsetof(UAkSubmixInputComponent, SubmixToRecord) == 0x000418, "Member 'UAkSubmixInputComponent::SubmixToRecord' has a wrong offset!");
