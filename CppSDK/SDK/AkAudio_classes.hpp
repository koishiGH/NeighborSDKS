...
static_assert(offsetof(UAkGameObject, bOverrideAttenuationScalingFactor) == 0x000230, "Member 'UAkGameObject::bOverrideAttenuationScalingFactor' has a wrong offset!");
static_assert(offsetof(UAkGameObject, AttenuationScalingFactor) == 0x000234, "Member 'UAkGameObject::AttenuationScalingFactor' has a wrong offset!");
...
public:
	...
	bool                                          DrawFirstOrderReflections;                         // 0x0284(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawSecondOrderReflections;                        // 0x0285(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawHigherOrderReflections;                        // 0x0286(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawDiffraction;                                   // 0x0287(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bUseReverbVolumes;                                 // 0x0289(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_28A[0x1AE];                                    // 0x028A(0x01AE)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAkComponent, DrawFirstOrderReflections) == 0x000284, "Member 'UAkComponent::DrawFirstOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawSecondOrderReflections) == 0x000285, "Member 'UAkComponent::DrawSecondOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawHigherOrderReflections) == 0x000286, "Member 'UAkComponent::DrawHigherOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawDiffraction) == 0x000287, "Member 'UAkComponent::DrawDiffraction' has a wrong offset!");
...
static_assert(offsetof(UAkComponent, bUseReverbVolumes) == 0x000289, "Member 'UAkComponent::bUseReverbVolumes' has a wrong offset!");
...
public:
	...
	class AActor*                                 ParentRoomActor;                                   // 0x0260(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
