...
struct FLiveLinkFrameRate final
{
public:
	uint32                                        Numerator;                                         // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        Denominator;                                       // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FLiveLinkFrameRate, Numerator) == 0x000000, "Member 'FLiveLinkFrameRate::Numerator' has a wrong offset!");
static_assert(offsetof(FLiveLinkFrameRate, Denominator) == 0x000004, "Member 'FLiveLinkFrameRate::Denominator' has a wrong offset!");

// ScriptStruct LiveLinkInterface.LiveLinkTimeCode
// 0x0010 (0x0010 - 0x0000)
struct FLiveLinkTimeCode final
{
public:
...
static_assert(offsetof(FLiveLinkTimeCode, Seconds) == 0x000000, "Member 'FLiveLinkTimeCode::Seconds' has a wrong offset!");
static_assert(offsetof(FLiveLinkTimeCode, Frames) == 0x000004, "Member 'FLiveLinkTimeCode::Frames' has a wrong offset!");
static_assert(offsetof(FLiveLinkTimeCode, FrameRate) == 0x000008, "Member 'FLiveLinkTimeCode::FrameRate' has a wrong offset!");
