...
{
public:
	UMulticastDelegateProperty_                   OnLeaveBounds;                                     // 0x01D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnReturnToBounds;                                  // 0x01E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USteamVRChaperoneComponent) == 0x000200, "Wrong size on USteamVRChaperoneComponent");
static_assert(offsetof(USteamVRChaperoneComponent, OnLeaveBounds) == 0x0001D0, "Member 'USteamVRChaperoneComponent::OnLeaveBounds' has a wrong offset!");
static_assert(offsetof(USteamVRChaperoneComponent, OnReturnToBounds) == 0x0001E0, "Member 'USteamVRChaperoneComponent::OnReturnToBounds' has a wrong offset!");
