...
static_assert(alignof(WheeledVehicleMovementComponent_SetAvoidanceGroupMask) == 0x000001, "Wrong alignment on WheeledVehicleMovementComponent_SetAvoidanceGroupMask");
...
static_assert(alignof(WheeledVehicleMovementComponent_SetGroupsToAvoidMask) == 0x000001, "Wrong alignment on WheeledVehicleMovementComponent_SetGroupsToAvoidMask");
...
static_assert(alignof(WheeledVehicleMovementComponent_SetGroupsToIgnoreMask) == 0x000001, "Wrong alignment on WheeledVehicleMovementComponent_SetGroupsToIgnoreMask");
