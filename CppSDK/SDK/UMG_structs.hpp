...
static_assert(alignof(FMovieScene2DTransformSectionTemplate) == 0x000001, "Wrong alignment on FMovieScene2DTransformSectionTemplate");
...
static_assert(alignof(FMovieSceneMarginSectionTemplate) == 0x000001, "Wrong alignment on FMovieSceneMarginSectionTemplate");
