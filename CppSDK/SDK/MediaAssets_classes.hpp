...
public:
	...
	class UMediaPlayer*                           MediaPlayer;                                       // 0x06B8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMediaSoundComponent) == 0x000730, "Wrong size on UMediaSoundComponent");
static_assert(offsetof(UMediaSoundComponent, Channels) == 0x0006B0, "Member 'UMediaSoundComponent::Channels' has a wrong offset!");
static_assert(offsetof(UMediaSoundComponent, MediaPlayer) == 0x0006B8, "Member 'UMediaSoundComponent::MediaPlayer' has a wrong offset!");
