...
static_assert(alignof(FQuat) == 0x000004, "Wrong alignment on FQuat");
...
static_assert(alignof(FVector4) == 0x000004, "Wrong alignment on FVector4");
...
static_assert(alignof(FDateTime) == 0x000001, "Wrong alignment on FDateTime");
...
static_assert(alignof(FTimespan) == 0x000001, "Wrong alignment on FTimespan");
