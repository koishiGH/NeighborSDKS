...
public:
	...
	static int32 AddLocalNavigationGridForPoints(class UObject* WorldContext, const TArray<struct FVector>& Locations, const int32 Radius2D, const float Height, bool bRebuildGrids);
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x0004C0, "Wrong size on UGridPathFollowingComponent");
