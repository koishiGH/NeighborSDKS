...
static_assert(sizeof(ABP_GameMode_C) == 0x0004F8, "Wrong size on ABP_GameMode_C");
static_assert(offsetof(ABP_GameMode_C, DefaultSceneRoot) == 0x0004F0, "Member 'ABP_GameMode_C::DefaultSceneRoot' has a wrong offset!");
