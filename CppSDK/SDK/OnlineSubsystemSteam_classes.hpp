...
static_assert(sizeof(USteamNetDriver) == 0x000570, "Wrong size on USteamNetDriver");
...
public:
	...
	uint8                                         Pad_1911[0x7];                                     // 0x1911(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x001918, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001910, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
