...
public:
	...
	struct FKey                                   DragKey;                                           // 0x00B0(0x0018)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	struct FEventReply                            Reply;                                             // 0x0000(0x00A8)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FVector2D                              NewMousePosition;                                  // 0x00A8(0x0008)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FEventReply                            ReturnValue;                                       // 0x00B0(0x00A8)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
