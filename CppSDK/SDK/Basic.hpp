...
namespace Offsets
{
	constexpr int32 GObjects          = 0x02E46020;
	constexpr int32 AppendString      = 0x002B9BA0;
	constexpr int32 GNames            = 0x02E0B4F8;
	constexpr int32 GWorld            = 0x02E575D0;
	constexpr int32 ProcessEvent      = 0x003F21F0;
	constexpr int32 ProcessEventIdx   = 0x0000003A;
}
