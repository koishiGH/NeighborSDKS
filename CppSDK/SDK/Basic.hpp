...
namespace Offsets
{
	constexpr int32 GObjects          = 0x07F0A220;
	constexpr int32 AppendString      = 0x010D4B00;
	constexpr int32 GNames            = 0x07E53500;
	constexpr int32 GWorld            = 0x0808A588;
	constexpr int32 ProcessEvent      = 0x012BFE60;
