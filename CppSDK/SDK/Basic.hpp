...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0506D250;
	constexpr int32 AppendString      = 0x012B22D0;
	constexpr int32 GNames            = 0x05030F00;
	constexpr int32 GWorld            = 0x051B5FF0;
	constexpr int32 ProcessEvent      = 0x014A2BF0;
