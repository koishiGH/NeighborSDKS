...
// 0x0568 (0x0920 - 0x03B8)
class UVehicleAnimInstance final : public UAnimInstance
{
public:
	uint8                                         Pad_3B8[0x558];                                    // 0x03B8(0x0558)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UVehicleAnimInstance) == 0x000920, "Wrong size on UVehicleAnimInstance");
static_assert(offsetof(UVehicleAnimInstance, WheeledVehicleMovementComponent) == 0x000910, "Member 'UVehicleAnimInstance::WheeledVehicleMovementComponent' has a wrong offset!");
