...
// 0x03F8 (0x0750 - 0x0358)
class UVehicleAnimInstance final : public UAnimInstance
{
public:
	uint8                                         Pad_358[0x3E8];                                    // 0x0358(0x03E8)(Fixing Size After Last Property [ Dumper-7 ])
	class UWheeledVehicleMovementComponent*       WheeledVehicleMovementComponent;                   // 0x0740(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVehicleAnimInstance) == 0x000750, "Wrong size on UVehicleAnimInstance");
static_assert(offsetof(UVehicleAnimInstance, WheeledVehicleMovementComponent) == 0x000740, "Member 'UVehicleAnimInstance::WheeledVehicleMovementComponent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2AD[0x2B];                                     // 0x02AD(0x002B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UWheeledVehicleMovementComponent4W, DifferentialSetup) == 0x000368, "Member 'UWheeledVehicleMovementComponent4W::DifferentialSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, TransmissionSetup) == 0x000388, "Member 'UWheeledVehicleMovementComponent4W::TransmissionSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, SteeringCurve) == 0x0003B8, "Member 'UWheeledVehicleMovementComponent4W::SteeringCurve' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, AckermannAccuracy) == 0x000430, "Member 'UWheeledVehicleMovementComponent4W::AckermannAccuracy' has a wrong offset!");
