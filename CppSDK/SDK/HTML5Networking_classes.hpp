...
{
public:
	uint8                                         Pad_337B0[0x10];                                   // 0x337B0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWebSocketConnection) == 0x0337C0, "Wrong size on UWebSocketConnection");
...
{
public:
	int32                                         WebSocketPort;                                     // 0x0508(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_50C[0xC];                                      // 0x050C(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWebSocketNetDriver) == 0x000518, "Wrong size on UWebSocketNetDriver");
static_assert(offsetof(UWebSocketNetDriver, WebSocketPort) == 0x000508, "Member 'UWebSocketNetDriver::WebSocketPort' has a wrong offset!");
