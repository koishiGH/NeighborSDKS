...
{
public:
	int32                                         WebSocketPort;                                     // 0x0408(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_40C[0xC];                                      // 0x040C(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWebSocketNetDriver) == 0x000418, "Wrong size on UWebSocketNetDriver");
static_assert(offsetof(UWebSocketNetDriver, WebSocketPort) == 0x000408, "Member 'UWebSocketNetDriver::WebSocketPort' has a wrong offset!");
