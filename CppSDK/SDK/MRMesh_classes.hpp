...
static_assert(offsetof(UMRMeshComponent, Material) == 0x000668, "Member 'UMRMeshComponent::Material' has a wrong offset!");
static_assert(offsetof(UMRMeshComponent, MeshReconstructor) == 0x000670, "Member 'UMRMeshComponent::MeshReconstructor' has a wrong offset!");
static_assert(offsetof(UMRMeshComponent, bEnableCollision) == 0x000678, "Member 'UMRMeshComponent::bEnableCollision' has a wrong offset!");
static_assert(offsetof(UMRMeshComponent, BodySetups) == 0x000680, "Member 'UMRMeshComponent::BodySetups' has a wrong offset!");
