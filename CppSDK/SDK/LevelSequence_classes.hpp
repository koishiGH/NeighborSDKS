...
public:
	...
	TArray<class UObject*>                        AdditionalEventReceivers;                          // 0x0720(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULevelSequencePlayer) == 0x000780, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, AdditionalEventReceivers) == 0x000720, "Member 'ULevelSequencePlayer::AdditionalEventReceivers' has a wrong offset!");
