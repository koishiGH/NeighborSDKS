...
static_assert(offsetof(NavLocalGridManager_AddLocalNavigationGridForPoints, WorldContext) == 0x000000, "Member 'NavLocalGridManager_AddLocalNavigationGridForPoints::WorldContext' has a wrong offset!");
