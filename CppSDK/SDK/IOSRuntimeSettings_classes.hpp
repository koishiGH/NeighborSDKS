...
public:
	...
	class FString                                 IOSTeamID;                                         // 0x0158(0x0010)(Edit, ZeroConstructor, Config, GlobalConfig, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisableHTTPS;                                     // 0x0168(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         MaxShaderLanguageVersion;                          // 0x0169(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          UseFastIntrinsics;                                 // 0x016A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          EnableMathOptimisations;                           // 0x016B(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseIntegratedKeyboard;                            // 0x016C(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_16D[0x3];                                      // 0x016D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         AudioSampleRate;                                   // 0x0170(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AudioCallbackBufferFrameSize;                      // 0x0174(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AudioNumBuffersToEnqueue;                          // 0x0178(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AudioMaxChannels;                                  // 0x017C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AudioNumSourceWorkers;                             // 0x0180(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_184[0x4];                                      // 0x0184(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 SpatializationPlugin;                              // 0x0188(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ReverbPlugin;                                      // 0x0198(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 OcclusionPlugin;                                   // 0x01A8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UIOSRuntimeSettings) == 0x0001B8, "Wrong size on UIOSRuntimeSettings");
...
static_assert(offsetof(UIOSRuntimeSettings, IOSTeamID) == 0x000158, "Member 'UIOSRuntimeSettings::IOSTeamID' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, bDisableHTTPS) == 0x000168, "Member 'UIOSRuntimeSettings::bDisableHTTPS' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, MaxShaderLanguageVersion) == 0x000169, "Member 'UIOSRuntimeSettings::MaxShaderLanguageVersion' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, UseFastIntrinsics) == 0x00016A, "Member 'UIOSRuntimeSettings::UseFastIntrinsics' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, EnableMathOptimisations) == 0x00016B, "Member 'UIOSRuntimeSettings::EnableMathOptimisations' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, bUseIntegratedKeyboard) == 0x00016C, "Member 'UIOSRuntimeSettings::bUseIntegratedKeyboard' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, AudioSampleRate) == 0x000170, "Member 'UIOSRuntimeSettings::AudioSampleRate' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, AudioCallbackBufferFrameSize) == 0x000174, "Member 'UIOSRuntimeSettings::AudioCallbackBufferFrameSize' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, AudioNumBuffersToEnqueue) == 0x000178, "Member 'UIOSRuntimeSettings::AudioNumBuffersToEnqueue' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, AudioMaxChannels) == 0x00017C, "Member 'UIOSRuntimeSettings::AudioMaxChannels' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, AudioNumSourceWorkers) == 0x000180, "Member 'UIOSRuntimeSettings::AudioNumSourceWorkers' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, SpatializationPlugin) == 0x000188, "Member 'UIOSRuntimeSettings::SpatializationPlugin' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, ReverbPlugin) == 0x000198, "Member 'UIOSRuntimeSettings::ReverbPlugin' has a wrong offset!");
static_assert(offsetof(UIOSRuntimeSettings, OcclusionPlugin) == 0x0001A8, "Member 'UIOSRuntimeSettings::OcclusionPlugin' has a wrong offset!");
