...
{
public:
	uint8                                         Pad_337B0[0x20];                                   // 0x337B0(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x0337D0, "Wrong size on UIpConnection");
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x0006C0, "Wrong size on UVoipListenerSynthComponent");
...
public:
	...
	uint8                                         Pad_351[0x7F];                                     // 0x0351(0x007F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconClient) == 0x0003D0, "Wrong size on AOnlineBeaconClient");
...
{
public:
	uint8                                         Pad_3D0[0xC0];                                     // 0x03D0(0x00C0)(Fixing Size After Last Property [ Dumper-7 ])
