...
// ScriptStruct GameplayAbilities.BalanceTableFloat
// 0x0050 (0x0050 - 0x0000)
struct FBalanceTableFloat final
{
public:
	struct FScalableFloat                         Coefficient;                                       // 0x0000(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         Step;                                              // 0x0028(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FBalanceTableFloat) == 0x000008, "Wrong alignment on FBalanceTableFloat");
static_assert(sizeof(FBalanceTableFloat) == 0x000050, "Wrong size on FBalanceTableFloat");
static_assert(offsetof(FBalanceTableFloat, Coefficient) == 0x000000, "Member 'FBalanceTableFloat::Coefficient' has a wrong offset!");
static_assert(offsetof(FBalanceTableFloat, Step) == 0x000028, "Member 'FBalanceTableFloat::Step' has a wrong offset!");
...
public:
	...
	struct FBalanceTableFloat                     BalanceTableFloat;                                 // 0x01E0(0x0050)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FGameplayEffectModifierMagnitude) == 0x000008, "Wrong alignment on FGameplayEffectModifierMagnitude");
static_assert(sizeof(FGameplayEffectModifierMagnitude) == 0x000230, "Wrong size on FGameplayEffectModifierMagnitude");
...
static_assert(offsetof(FGameplayEffectModifierMagnitude, BalanceTableFloat) == 0x0001E0, "Member 'FGameplayEffectModifierMagnitude::BalanceTableFloat' has a wrong offset!");
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0050(0x0230)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayModEvaluationChannelSettings  EvaluationChannelSettings;                         // 0x0280(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_281[0x7];                                      // 0x0281(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagRequirements               SourceTags;                                        // 0x0288(0x0088)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x0310(0x0088)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FGameplayEffectExecutionScopedModifierInfo) == 0x000398, "Wrong size on FGameplayEffectExecutionScopedModifierInfo");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, EvaluationChannelSettings) == 0x000280, "Member 'FGameplayEffectExecutionScopedModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, SourceTags) == 0x000288, "Member 'FGameplayEffectExecutionScopedModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, TargetTags) == 0x000310, "Member 'FGameplayEffectExecutionScopedModifierInfo::TargetTags' has a wrong offset!");
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0040(0x0230)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	...
	struct FGameplayTagRequirements               SourceTags;                                        // 0x0278(0x0088)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x0300(0x0088)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayModifierInfo) == 0x000008, "Wrong alignment on FGameplayModifierInfo");
static_assert(sizeof(FGameplayModifierInfo) == 0x000388, "Wrong size on FGameplayModifierInfo");
