...
static_assert(alignof(FVehicleAnimInstanceProxy) == 0x000001, "Wrong alignment on FVehicleAnimInstanceProxy");
static_assert(sizeof(FVehicleAnimInstanceProxy) == 0x0004D0, "Wrong size on FVehicleAnimInstanceProxy");
