...
static_assert(sizeof(FAnimNode_WheelHandler) == 0x000130, "Wrong size on FAnimNode_WheelHandler");
...
static_assert(sizeof(FVehicleAnimInstanceProxy) == 0x000580, "Wrong size on FVehicleAnimInstanceProxy");
