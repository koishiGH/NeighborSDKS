...
public:
	...
	UMulticastDelegateProperty_                   OnClaimedResourcesChange;                          // 0x0220(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayTasksComponent) == 0x000240, "Wrong size on UGameplayTasksComponent");
...
static_assert(offsetof(UGameplayTasksComponent, OnClaimedResourcesChange) == 0x000220, "Member 'UGameplayTasksComponent::OnClaimedResourcesChange' has a wrong offset!");
