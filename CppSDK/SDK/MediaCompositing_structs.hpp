...
public:
	...
	class UTexture*                               MediaTexture;                                      // 0x0038(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMediaPlaneParameters) == 0x000008, "Wrong alignment on FMediaPlaneParameters");
static_assert(sizeof(FMediaPlaneParameters) == 0x000040, "Wrong size on FMediaPlaneParameters");
...
static_assert(offsetof(FMediaPlaneParameters, MediaTexture) == 0x000038, "Member 'FMediaPlaneParameters::MediaTexture' has a wrong offset!");
...
public:
	...
	float                                         SectionEndTime;                                    // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SectionStartTime;                                  // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FMovieSceneMediaSectionParams, SectionEndTime) == 0x000028, "Member 'FMovieSceneMediaSectionParams::SectionEndTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, SectionStartTime) == 0x00002C, "Member 'FMovieSceneMediaSectionParams::SectionStartTime' has a wrong offset!");
